...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name(), 'Star Exchange Token');
    assert.equal(await instance.symbol(), 'SET');
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('impressive star', starId2, {from: user2});
